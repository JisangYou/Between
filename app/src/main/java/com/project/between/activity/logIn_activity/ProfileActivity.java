...
import com.project.between.activity.ChattingActivity;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String myNum = PreferenceUtil.getStringValue(this, ConstantUtil.MY_NUMBER);
        photoRef = database.getReference(ConstantUtil.PHOTO).child(photoRoom).child(ConstantUtil.PROFILE).child(myNum);
    ...
    public void movetohome(View view) {
        ...
        intentForChat.putExtra(ConstantUtil.TEMP_KEY, tempkey);
    ...
    public void addDatabase() {
        ...
        userRef.child(tempkey).child(ConstantUtil.NAME).setValue(name);
    ...
    public void getIntentFromPhoneConnectActivity() {
        ...
        tempkey = intent.getExtras().getString(ConstantUtil.TEMP_KEY2);
    }
